...
public final class Constants {
    ...
    public static final int DRIVETRAIN_BACK_LEFT_MOTOR = 2;

    public static final int DRIVETRAIN_FRONT_RIGHT_MOTOR = 3;
    public static final int DRIVETRAIN_BACK_RIGHT_MOTOR = 4;
